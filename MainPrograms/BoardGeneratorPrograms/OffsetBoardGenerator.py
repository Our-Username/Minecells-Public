...
if __name__ == "__main__":
	...
	args: tuple = (
		...
		(0, 0),  # start_pos
		10,  # minecount
		"",  # seed MySeed123, CSeEQjhvzD
		0,  # space_count
		[(-1, 0), (0, -1), (1, 1)]  #directions
		# [(2, 1), (-2, 1), (2, -1), (-2, -1), (1, 2), (-1, 2), (1, -2), (-1, -2)]=Knight's move
		# [(-2, -2), (-1, -2), (0, -2), (1, -2), (2, -2), (2, -1), (2, 0), (2, 1), (2, 2), (1, 2), (0, 2), (-1, 2), (-2, 2), (-2, 1), (-2, 0), (-2, 1)]=Ring
	)
	
	board_gen: OffsetBoardGenerator = OffsetBoardGenerator(*args)  # instance of my board generator
	pr = cProfile.Profile()
	pr.enable()
